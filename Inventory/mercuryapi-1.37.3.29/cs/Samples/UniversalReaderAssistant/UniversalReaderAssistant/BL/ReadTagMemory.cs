...
namespace ThingMagic.URA2.BL
{
    public class ReadTagMemory
    {
                ...
                while (false == isAllDataReceived)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        catch (Exception exception)
                        {
                            ...
                            if (exception is FAULT_GEN2_PROTOCOL_MEMORY_OVERRUN_BAD_PC_Exception || (-1 != exception.Message.IndexOf("LLRP reader unknown error")) || (-1 != exception.Message.IndexOf("General Tag Error")) || (-1 != exception.Message.IndexOf("Tag data access failed")))
                            {
                                if (dataTemp.Count > 0)
                                {
        ...
        /// or LLRP reader unknown error or General Tag Error or Tag data access failed exception
        ...
        private void ReadTagMemoryWordByWord(Gen2.Bank bank, TagFilter filter, ref ushort[] data)
        {
            lock (new Object())
            {
                ...
                while (false == isAllDataReceived)
                {
                    ...
                    {
                        if (exception is FAULT_GEN2_PROTOCOL_MEMORY_OVERRUN_BAD_PC_Exception || (-1 != exception.Message.IndexOf("LLRP reader unknown error")) || (-1 != exception.Message.IndexOf("General Tag Error")) || (-1 != exception.Message.IndexOf("Tag data access failed")) || (exception.Message.Contains("Gen2 memory overrun - bad PC")
        ...
        /// <summary>
        /// Read tag memory for readers or modules
        /// </summary>
        /// <param name="bank">Gen2 memory bank</param>
        /// <param name="filter">filter</param>
        ...
        private void ReadMemoryM6eVariants(Gen2.Bank bank, TagFilter filter, ref ushort[] MemData)
        {
            try
            {
                // Read tag memory with zero as start address and length of words to read as zero
