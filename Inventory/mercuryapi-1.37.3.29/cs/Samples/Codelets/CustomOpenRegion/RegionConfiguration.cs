...
namespace RegionConfiguration
{
    ...
    /// Set to OPEN region and customise according to the users inputs
    /// </summary>
        ...
        */
        ...
        static void Usage()
        {
            Console.WriteLine(String.Join("\r\n", new string[] {
                    " Usage: "+"Please provide valid reader URL, such as: [-v] [reader-uri] [--ant n[,n...]] [--region k]",
                    " -v : (Verbose)Turn on transport listener",
                    " reader-uri : e.g., 'tmr:///com4' or 'tmr:///dev/ttyS0/' or 'tmr://readerIP'",
                    " [--ant n[,n...]] : e.g., '--ant 1,2,..,n",
                    " [--region k] : e.g, '--region 0' or --region 1 or --region 2\n" +
                    " where '0' - DEFAULT\n" +
                    "       '1' - BAHRAIN\n" +
                    "       '2' - BRAZIL\n",
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                using (Reader r = Reader.Create(args[0]))
                {
                    ...
                    /*
                     * Uncomment Step 10 through 11 to save OPEN region settings as persistent. 
                     */
