...
MERCURYAPI_CS_OUTPUTS += $(MERCURYAPI_CS_DIR)/MercuryAPI.dll $(MERCURYAPI_CS_DIR)/MercuryAPI.xml
...
CABWIZ ?= "/cygdrive/c/Program Files (x86)/Windows Mobile 6 SDK/Tools/CabWiz/Cabwiz.exe"
...
$(eval $(call AddSolution,$(MSBUILD22),MercuryAPI.sln,\
 #MercuryAPICE.dll\
 MercuryAPI.dll\
 MercuryAPI.xml\
))

$(eval $(call AddSolution,$(MSBUILD22),Samples/Codelets/Codelets.sln,\
 $(foreach codelet,\
   BlockPermaLock\
   BlockWrite\
   CommandTime\
...
$(eval $(call AddSample,$(MSBUILD22),UniversalReaderAssistant))
...
#else
#SHFB ?= "/cygdrive/c/Program Files (x86)/EWSoftware/Sandcastle Help File Builder/SandcastleBuilderConsole.exe"
#endif
...
mapi_cs_set_ura2_build_number: $(MERCURYAPI_CS_DIR)/Samples/UniversalReaderAssistant/UniversalReaderAssistant/Properties/AssemblyInfo.cs
