  ...
  llrp_u64_t                    Value)
{
    ...
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 56u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 48u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 40u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 32u);

    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 24u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 16u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 8u);
    pEncoder->pBuffer[pEncoder->iNext++] = (unsigned char)(Value >> 0u);
}
