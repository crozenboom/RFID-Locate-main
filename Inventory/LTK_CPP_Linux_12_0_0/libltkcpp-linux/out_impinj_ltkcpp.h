...
class CImpinjEnableXPCWords;
class CImpinjXPCWords;
...
class CImpinjEnableCRHandle;
class CImpinjCRHandle;
class CImpinjEnableEnhancedIntegra;
class CImpinjEnhancedIntegraReport;
...
enum EImpinjRegulatoryRegion
{
    ...
    ImpinjRegulatoryRegion_Chile = 33, /**< Chile */ 
    ImpinjRegulatoryRegion_Colombia = 34, /**< Colombia */ 
    ImpinjRegulatoryRegion_South_Africa_915_919_MHz_Alternate = 35, /**< South_Africa_915_919_MHz_Alternate */ 
    ImpinjRegulatoryRegion_Venezuela = 36, /**< Venezuela */  
};
...
/**
 ** @brief  Global enumeration EImpinjXPCWordsMode for LLRP enumerated field ImpinjXPCWordsMode
 **
...
enum EImpinjXPCWordsMode
{

    ImpinjXPCWordsMode_Disabled = 0, /**< Disabled */ 
    ImpinjXPCWordsMode_Enabled = 1, /**< Enabled */  
};

extern const SEnumTableEntry
g_estImpinjXPCWordsMode[];
...
enum EImpinjTagFilterVerificationMode
{
    ...
    ImpinjTagFilterVerificationMode_Passive = 2, /**< Passive */  
};
...
/**
 ** @brief  Global enumeration EImpinjCRHandleMode for LLRP enumerated field ImpinjCRHandleMode
 **
...
enum EImpinjCRHandleMode
{

    ImpinjCRHandleMode_Disabled = 0, /**< Disabled */ 
    ImpinjCRHandleMode_Enabled = 1, /**< Enabled */  
};

extern const SEnumTableEntry
g_estImpinjCRHandleMode[];


/**
 ** @brief  Global enumeration EImpinjEnhancedIntegraMode for LLRP enumerated field ImpinjEnhancedIntegraMode
 **
...
enum EImpinjEnhancedIntegraMode
{

    ImpinjEnhancedIntegraMode_Disabled = 0, /**< Disabled */ 
    ImpinjEnhancedIntegraMode_Enabled = 1, /**< Enabled */  
};

extern const SEnumTableEntry
g_estImpinjEnhancedIntegraMode[];


/**
 ** @brief  Global enumeration EImpinjEnhancedIntegraResultType for LLRP enumerated field ImpinjEnhancedIntegraResultType
 **
...
enum EImpinjEnhancedIntegraResultType
{

    ImpinjEnhancedIntegraResultType_No_Parity_Error = 0, /**< No_Parity_Error */ 
    ImpinjEnhancedIntegraResultType_PC_Parity_Error = 1, /**< PC_Parity_Error */ 
    ImpinjEnhancedIntegraResultType_EPC_Parity_Error = 2, /**< EPC_Parity_Error */ 
    ImpinjEnhancedIntegraResultType_PC_or_TID_Parity_Error = 3, /**< PC_or_TID_Parity_Error */ 
    ImpinjEnhancedIntegraResultType_EPC_or_TID_Parity_Error = 4, /**< EPC_or_TID_Parity_Error */ 
    ImpinjEnhancedIntegraResultType_Memory_Read_Parity_Error = 5, /**< Memory_Read_Parity_Error */  
};

extern const SEnumTableEntry
g_estImpinjEnhancedIntegraResultType[];
...
//@}
  ...
  protected:
    CImpinjEnableXPCWords * m_pImpinjEnableXPCWords;

  public:
    /** @brief Get accessor functions for the LLRP ImpinjEnableXPCWords sub-parameter */  
    inline CImpinjEnableXPCWords *
    getImpinjEnableXPCWords (void)
    {
        return m_pImpinjEnableXPCWords;
    }

    /** @brief Set accessor functions for the LLRP ImpinjEnableXPCWords sub-parameter */  
    EResultCode
    setImpinjEnableXPCWords (
      CImpinjEnableXPCWords * pValue);


  protected:
    CImpinjEnableCRHandle * m_pImpinjEnableCRHandle;

  public:
    /** @brief Get accessor functions for the LLRP ImpinjEnableCRHandle sub-parameter */  
    inline CImpinjEnableCRHandle *
    getImpinjEnableCRHandle (void)
    {
        return m_pImpinjEnableCRHandle;
    }

    /** @brief Set accessor functions for the LLRP ImpinjEnableCRHandle sub-parameter */  
    EResultCode
    setImpinjEnableCRHandle (
      CImpinjEnableCRHandle * pValue);


  protected:
    CImpinjEnableEnhancedIntegra * m_pImpinjEnableEnhancedIntegra;

  public:
    /** @brief Get accessor functions for the LLRP ImpinjEnableEnhancedIntegra sub-parameter */  
    inline CImpinjEnableEnhancedIntegra *
    getImpinjEnableEnhancedIntegra (void)
    {
        return m_pImpinjEnableEnhancedIntegra;
    }

    /** @brief Set accessor functions for the LLRP ImpinjEnableEnhancedIntegra sub-parameter */  
    EResultCode
    setImpinjEnableEnhancedIntegra (
      CImpinjEnableEnhancedIntegra * pValue);
...
<ul>
    ...
    <p> EnableSelectGapClose: Deprecated.</p> 
...
/**
 ** @brief  Class Definition CImpinjEnableXPCWords for LLRP parameter ImpinjEnableXPCWords
 **
...
<ul>
    ...
    <p>This custom parameter configures the reporting of Extended Protocol Control words.</p> 
 
        
    <p>XPCWordsMode: Disabled by default. When set to enabled, any backscattered Extended Protocol Control words will be provided along with the TagReportData.</p> 
 
      <SMALL><i>Copyright 2022 Impinj Inc.</i></SMALL> 
  <HR>
...
class CImpinjEnableXPCWords : public CParameter
{
  public:
    CImpinjEnableXPCWords (void);
    ~CImpinjEnableXPCWords (void);
...
//@}
  ...
  protected:
    EImpinjXPCWordsMode m_eXPCWordsMode;
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP XPCWordsMode field */
    inline EImpinjXPCWordsMode
    getXPCWordsMode (void)
    {
        return m_eXPCWordsMode;
    }

    /** @brief Set accessor functions for the LLRP XPCWordsMode field */
    inline void
    setXPCWordsMode (
      EImpinjXPCWordsMode value)
    {
        m_eXPCWordsMode = value;
    }
...
/**
 ** @brief  Class Definition CImpinjXPCWords for LLRP parameter ImpinjXPCWords
 **
...
<ul>
    ...
    <p>This custom parameter reports any Extended Protocol Control words that are backscattered during normal inventory.</p> 
 
        
    <p>XPCWords: A word vector containing the XPC data. The order of delivery is XPC_W1, then XPC_W2.</p> 
...
class CImpinjXPCWords : public CParameter
{
  public:
    CImpinjXPCWords (void);
    ~CImpinjXPCWords (void);
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP XPCWords field */
    inline llrp_u16v_t
    getXPCWords (void)
    {
        return m_XPCWords;
    ...
    /** @brief Set accessor functions for the LLRP XPCWords field */
    inline void
    setXPCWords (
      llrp_u16v_t value)
    {
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP SupportsESSpecs field */
    inline llrp_u1_t
    getSupportsESSpecs (void)
    {
        return m_SupportsESSpecs;
    }

    /** @brief Set accessor functions for the LLRP SupportsESSpecs field */
    inline void
    setSupportsESSpecs (
      llrp_u1_t value)
    {
        m_SupportsESSpecs = value;
    }
...
<ul>
    ...
    <p>This custom parameter allows the end user to enable/disable intelligent antenna management.</p> 
...
<ul>
    ...
    <p>TagFilterVerificationMode: Set to Active to enable tag filter verification, including automatic halting for access operations when required to validate the filter mask defined by the inventory Select configuration. Set to Passive to enable tag filter verification using only information contained in inventory Ack replies, bypassing validation if the filter configuration would require halting for access operations. Set to Disabled to completely bypass tag filter verification and rely solely on Select-based filtering by the tag. Defaults to Passive if not specified.</p> 
...
/**
 ** @brief  Class Definition CImpinjEnableCRHandle for LLRP parameter ImpinjEnableCRHandle
 **
...
<ul>
    ...
    <p>This custom parameter configures the ImpinjCRHandle feature.</p> 
...
class CImpinjEnableCRHandle : public CParameter
{
  public:
    CImpinjEnableCRHandle (void);
    ~CImpinjEnableCRHandle (void);
...
//@}
  ...
  protected:
    EImpinjCRHandleMode m_eCRHandleMode;
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP CRHandleMode field */
    inline EImpinjCRHandleMode
    getCRHandleMode (void)
    {
        return m_eCRHandleMode;
    }

    /** @brief Set accessor functions for the LLRP CRHandleMode field */
    inline void
    setCRHandleMode (
      EImpinjCRHandleMode value)
    {
        m_eCRHandleMode = value;
    }
...
/**
 ** @brief  Class Definition CImpinjCRHandle for LLRP parameter ImpinjCRHandle
 **
...
<ul>
    ...
    <p>This custom parameter reports the CR Handle returned in response to a Query/Rep/Adj or Scan command.</p> 
...
class CImpinjCRHandle : public CParameter
{
  public:
    CImpinjCRHandle (void);
    ~CImpinjCRHandle (void);
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP CRHandle field */
    inline llrp_u32_t
    getCRHandle (void)
    {
        return m_CRHandle;
    ...
    /** @brief Set accessor functions for the LLRP CRHandle field */
    inline void
    setCRHandle (
      llrp_u32_t value)
    {
...
/**
 ** @brief  Class Definition CImpinjEnableEnhancedIntegra for LLRP parameter ImpinjEnableEnhancedIntegra
 **
...
<ul>
    ...
    <p>This custom parameter configures the Enhanced Integra feature.</p> 
 
      <SMALL><i>Copyright 2024 Impinj Inc.</i></SMALL> 
  <HR>
...
class CImpinjEnableEnhancedIntegra : public CParameter
{
  public:
    CImpinjEnableEnhancedIntegra (void);
    ~CImpinjEnableEnhancedIntegra (void);
...
//@}
  ...
  protected:
    EImpinjEnhancedIntegraMode m_eEnhancedIntegraMode;

/** @name Internal Framework Functions */
//@{
  public:
    static const CFieldDescriptor
    s_fdEnhancedIntegraMode;
//@}

    /** @brief Get accessor functions for the LLRP EnhancedIntegraMode field */
    inline EImpinjEnhancedIntegraMode
    getEnhancedIntegraMode (void)
    {
        return m_eEnhancedIntegraMode;
    }

    /** @brief Set accessor functions for the LLRP EnhancedIntegraMode field */
    inline void
    setEnhancedIntegraMode (
      EImpinjEnhancedIntegraMode value)
    {
        m_eEnhancedIntegraMode = value;
    }
...
/**
 ** @brief  Class Definition CImpinjEnhancedIntegraReport for LLRP parameter ImpinjEnhancedIntegraReport
 **
...
<ul>
    ...
    <p>This custom parameter reports the result of the Enhanced Integra feature.</p> 
...
class CImpinjEnhancedIntegraReport : public CParameter
{
  public:
    CImpinjEnhancedIntegraReport (void);
    ~CImpinjEnhancedIntegraReport (void);
...
//@}
  ...
  protected:
    EImpinjEnhancedIntegraResultType m_eResult;
...
//@}
    ...
    /** @brief Get accessor functions for the LLRP Result field */
    inline EImpinjEnhancedIntegraResultType
    getResult (void)
    {
        return m_eResult;
    }
    ...
    inline void
    setResult (
      EImpinjEnhancedIntegraResultType value)
    {
        m_eResult = value;
    }
